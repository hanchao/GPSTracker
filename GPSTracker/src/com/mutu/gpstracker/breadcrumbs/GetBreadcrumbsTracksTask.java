...
public class GetBreadcrumbsTracksTask extends BreadcrumbsTask
{
      ...
      try
      {
         ...
         while (eventType != XmlPullParser.END_DOCUMENT)
         {
            ...
            else if (eventType == XmlPullParser.END_TAG)
            {
               ...
               {
                  mTracks.add(new Object[] { trackId, trackName, bundleId, description, difficulty, startTime, endTime,
                        isPublic, lat, lng, totalDistance, totalTime, trackRating });
               }
               tagName = null;
            }
   ...
   protected void updateTracksData(BreadcrumbsTracks tracks)
   {
      ...
      for (Object[] track : mTracks)
      {
         ...
         tracks.addTrack(trackId, trackName, bundleId, description, difficulty, startTime, endTime, isPublic, lat, lng,
