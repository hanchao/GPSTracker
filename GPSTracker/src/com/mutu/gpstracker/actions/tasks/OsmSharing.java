 ...
 *
 */
package com.mutu.gpstracker.actions.tasks;
...
import com.mutu.gpstracker.oauth.PrepareRequestTokenActivity;
...
public class OsmSharing extends GpxCreator
{
   ...
   private void sendToOsm(final Uri fileUri, final Uri trackUri)
   {
      ...
      try
      {
         ...
         if (sources != null && sources.contains(Constants.GOOGLE_PROVIDER))
         {
