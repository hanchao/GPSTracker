...
import com.mutu.gpstracker.viewer.map.overlay.OverlayProvider;
...
import com.mutu.mapapi.views.overlay.MyLocationOverlay;
...
//      }
   ...
   {
      GeoPoint localGeopoint = convertGeoPoint(geoPoint);
      mProjecton.toPixels(localGeopoint, screenPoint);
   }

   @Override
   public void toMapPixels(GeoPoint geoPoint, Point screenPoint)
   {
      GeoPoint localGeopoint = convertGeoPoint(geoPoint);
   ...
   static GeoPoint convertGeoPoint( GeoPoint point )
   {
