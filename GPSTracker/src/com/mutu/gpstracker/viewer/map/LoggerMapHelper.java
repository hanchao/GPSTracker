 ...
 *------------------------------------------------------------------------------
 */
package com.mutu.gpstracker.viewer.map;

import java.util.concurrent.Semaphore;

import com.mutu.gpstracker.actions.ControlTracking;
import com.mutu.gpstracker.actions.InsertNote;
import com.mutu.gpstracker.actions.ShareTrack;
import com.mutu.gpstracker.actions.Statistics;
...
import com.mutu.gpstracker.util.SlidingIndicatorView;
import com.mutu.gpstracker.util.UnitsI18n;
import com.mutu.gpstracker.viewer.About;
import com.mutu.gpstracker.viewer.ApplicationPreferenceActivity;
import com.mutu.gpstracker.viewer.TrackList;
import com.mutu.gpstracker.viewer.map.overlay.BitmapSegmentsOverlay;
import com.mutu.gpstracker.viewer.map.overlay.SegmentRendering;
